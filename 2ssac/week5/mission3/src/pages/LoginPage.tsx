  ...
  return (
    <div className="min-h-screen w-full bg-black text-white flex justify-center items-center px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        {/* 구글 로그인 */}
        <button className="w-full flex items-center justify-center py-2 border border-gray-500 rounded-lg hover:bg-white hover:text-black transition" onClick={handleGoogleLogin}>
